...
export default function ClientDetails({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tabs Navigation */}
      <div role="tablist" aria-label="Seções do cliente" className="inline-flex w-fit items-center gap-1 overflow-x-auto rounded-[10px] border border-slate-200 bg-white p-1 dark:border-zinc-800 dark:bg-zinc-900">
        {TABS.map((tab) => {
          const Icon = tab.icon;
